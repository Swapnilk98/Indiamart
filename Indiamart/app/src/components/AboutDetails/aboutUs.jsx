...
//   return (
//     <div id="aboutUs">
//       <h2 className="left">Blue Heaven Cosmetics (P) Ltd</h2>
...
//         </li>
//       </ul>
//       <h3 className="left">MAIN IDEA AND WORKING OF THE COMPANY</h3>
//       <ul>
//         <li className="left">
...
//           entered the personal care line enlarging its range and reach. Now BHC
//           offers more than 200 different products with huge variety.
//         </li>
//         <li className="left">
//           In such a competitive world, Blue Heaven has received an encouraging
//           response from its foreign clients where BH Kajals have become a rage.
//         </li>
//       </ul>
//       <h3 className="left">MOVING TO THE FUTURE</h3>
//       <ul>
//         <li className="left">Looking ahead in time, we aim to:</li>
//         <li className="left">
//           -Lead the industry in creating value for our customers and sales
//           channels
//         </li>
//         <li className="left">-Refocus the value we offer to our consumers</li>
//         <li className="left">-Increase operational excellence</li>
//         <li className="left">
...
//           manufacturers to produce high quality goods at low costs.
//         </li>
//         <li className="left">
//           The organization plans to keep up with the market demands.
//         </li>
//       </ul>
//       <AboutTable />
//       <h3 className="left">Manufacturing Unit</h3>
//       <ul>
//         <li className="left">
//           All the products are solely manufactured by plants owned by the
//           company in Delhi and Baddi (Himachal Pradesh).
//         </li>
//         <li className="left">
//           The products are manufactured as per the specifications of DRUG &
//           COSMETIC CONTROL DEPARTMENT by experienced work force under
//           supervision of skilled technical staff. The company has its in-house
//           R&D, Q/A, Q/C departments. They are facilitated by sophisticated
//           equipments under requisite technical supervision.
//         </li>
//         <li className="left">
